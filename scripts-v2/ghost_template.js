...
class Ghost {
    constructor(data){
        ...
        if (data.hunt_sanity === "???") {
            var huntValue = `<img src="imgs/speed/unknown.png" />`
        } else {
        ...
        <div class="ghost_card" id="${data.ghost}">
                ...
                <div class="ghost_hunt_info">
                    <div class="ghost_hunt ${parseInt(data.hunt_sanity) > 50 ?'high':parseInt(data.hunt_sanity) < 50 ? 'low':'average'}"><img src="imgs/sanity.png">${huntValue}</div>
					<div class="ghost_speed">
                        <img src="imgs/footsteps.png">
                        <div class="ghost_speed_values">
                            <img src=\"imgs/speed/${data.speed}.png\" class=\"speedIcon\" />
                        </div>
                    </div>
                </div>
